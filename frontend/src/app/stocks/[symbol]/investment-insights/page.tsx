...
import { useInvestmentInsightSummaryForStock } from "@/features/stocks/hooks/useStockOverview";
...
export default function StockInvestmentInsightsPage() {
  ...
  const { data, isLoading, error } = useInvestmentInsightSummaryForStock(
    symbol,
    page,
    10
  );
      ...
      <div className="px-8 py-8 max-w-7xl mx-auto space-y-6">
        ...
        >
          ...
          <p className="text-sm" style={{ color: colors.textMuted }}>
            AI investment reviews and recommendations for {companyName}.
          </p>
        </div>
        ...
        {!isLoading && !error && data && data.content.length === 0 && (
          ...
          >
            ...
            <span className="text-sm" style={{ color: colors.textMuted }}>
              No investment insights found for {symbol}.
            </span>
          </div>
        )}
