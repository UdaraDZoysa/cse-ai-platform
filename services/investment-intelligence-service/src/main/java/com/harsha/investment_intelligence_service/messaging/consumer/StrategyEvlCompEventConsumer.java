...
@Component
public class StrategyEvlCompEventConsumer {
    private final ObjectMapper objectMapper;
    private final InboxRepository inboxRepository;

    public StrategyEvlCompEventConsumer(
    ...
    @Transactional
    @KafkaListener(topics = KafkaTopics.STRATEGY_EVALUATION_COMPLETED_EVENT_V1, groupId = "${spring.kafka.consumer.group-id}")
