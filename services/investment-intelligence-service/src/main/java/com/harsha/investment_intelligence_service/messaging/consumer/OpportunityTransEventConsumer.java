...
@Component
public class OpportunityTransEventConsumer {
    private final ObjectMapper objectMapper;
    private final InboxRepository inboxRepository;

    public OpportunityTransEventConsumer(
    ...
    @Transactional
    @KafkaListener(topics = KafkaTopics.OPPORTUNITY_TRANSITION_EVENT_V1, groupId = "${spring.kafka.consumer.group-id}")
