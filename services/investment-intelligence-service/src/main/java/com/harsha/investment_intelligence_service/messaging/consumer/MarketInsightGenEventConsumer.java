...
@Component
public class MarketInsightGenEventConsumer {
    private final ObjectMapper objectMapper;
    private final InboxRepository inboxRepository;

    public MarketInsightGenEventConsumer(
    ...
    @Transactional
    @KafkaListener(topics = KafkaTopics.MARKET_INSIGHT_GENERATED_EVENT_V1, groupId = "${spring.kafka.consumer.group-id}")
